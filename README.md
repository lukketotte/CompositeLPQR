...
```
Note that mcmc returns a `vector` with the first element being of type `::MCMCchains`, see [https://juliapackages.com/p/mcmcchains](https://juliapackages.com/p/mcmcchains)
